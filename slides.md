...
## Modern Software Deployment on Alps
...
CSCS developed a CI/CD external service to provide GitHub, GitLab and BitBucket projects with *first-class* CI/CD on HPC systems

* Users register and configure pipelines in a web UI.
* Triggered by webhooks on PRs and merges.
* Feedback directly on GitHub/GitLab pull request.

[`docs.cscs.ch/services/cicd`](https://docs.cscs.ch/services/cicd/)

* uses GitLab under the hood with specialized FirecREST runners
* build jobs can run in containers or bare metal

[Example PR](https://github.com/eth-cscs/alps-uenv/pull/255)
...
* Empowering staff empowers users:
    ...
    * Users accepted uenv with little fuss
* Software stacks over 2 years old are still working.
...
* Support for other sites
    ...
    * There are some site-specific components.
    * LANL plan to use uenv in production in 2026.
